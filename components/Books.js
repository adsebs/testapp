...
export default {
    ...
    template: `
        ...
        <h2>Reading</h2>
        <make-table type="reading" :tblcols :books></make-table>
        <h2>TBR</h2>
        <make-table type="tbr" :tblcols :books></make-table>
        <h2>Read</h2>
        <make-table type="read" :tblcols :books></make-table>
    ...
    data() {
        ...
        return {
            ...
            books: [
                {title: "The Map that Led to You",                  author: "Ella Mcleod",      gender: "female",   country: "UK",      genre: "Fantasy",       pages: 480, pubYear: 2024, format: "paperback",     dateStart: "", dateEnd: "", rating: "", status: "read", collection: true},
                {title: "The Final Strife",                         author: "Saara El Arifi",   gender: "female",   country: "UK",      genre: "Fantasy",       pages: 512, pubYear: 2022, format: "paperback",     dateStart: "2024-09-02", dateEnd: "", rating: "", status: "reading", collection: true},
                ...
                {title: "When Among Crows",                         author: "Veronica Roth",    gender: "female",   country: "USA",     genre: "Fantasy",       pages: 165, pubYear: 2024, format: "hardback",      dateStart: "", dateEnd: "", rating: "", status: "tbr", collection: true},
                {title: "In a Glass Darkly",                        author: "Sheridan Le Fanu", gender: "male",     country: "Ireland", genre: "Gothic",        pages: 384, pubYear: 1972, format: "paperback",     dateStart: "", dateEnd: "", rating: "", status: "read", collection: false},
                {title: "Days at the Morisaki Bookshop",            author: "Satoshi Yagisawa", gender: "male",     country: "Japan",   genre: "Contemporary",  pages: 147, pubYear: 2023, format: "paperback",     dateStart: "2024-09-06", dateEnd: "", rating: "", status: "reading", collection: false},
                {title: "Delicious In Dungeon",                     author: "Ryoko Kui",        gender: "female",   country: "Japan",   genre: "Fantasy",       pages: 192, pubYear: 2015, format: "graphic",       dateStart: "", dateEnd: "", rating: "", status: "tbr", collection: true},
                {title: "Wisteria",                                 author: "Adalyn Grace",     gender: "female",   country: "USA",     genre: "Gothic",        pages: 419, pubYear: 2024, format: "hardback",      dateStart: "", dateEnd: "", rating: "", status: "read", collection: true},
                {title: "The Phoenix Keeper",                       author: "S.A. MacLean",     gender: "female",   country: "USA",     genre: "Fantasy",       pages: 464, pubYear: 2024, format: "hardback",      dateStart: "", dateEnd: "", rating: "", status: "tbr", collection: false},
                {title: "The Hitchhiker's Guide to the Galaxy",     author: "Douglas Adams",    gender: "male",     country: "UK",      genre: "Sci-Fi",        pages: 180, pubYear: 1979, format: "paperback",     dateStart: "", dateEnd: "", rating: "", status: "tbr", collection: false},
                {title: "The Wheel Spins",                          author: "Ethel Lina White", gender: "female",   country: "UK",      genre: "Crime",         pages: 255, pubYear: 1935, format: "paperback",     dateStart: "", dateEnd: "", rating: "", status: "read", collection: true},
                {title: "Becoming",                                 author: "Michelle Obama",   gender: "female",   country: "USA",     genre: "Memoir",        pages: 464, pubYear: 2021, format: "audiobook",     dateStart: "2024-09-13", dateEnd: "", rating: "", status: "reading", collection: true},
                ...
                {title: "Ctrl, Alt; Delete: How I Grew Up Online",  author: "Emma Gannon",      gender: "female",   country: "UK",      genre: "Memoir",        pages: 272, pubYear: 2016, format: "e-book",        dateStart: "", dateEnd: "", rating: "", status: "read", collection: false},
